...
export default async function Page() {
    ...
    return (
        <main className="container mx-auto px-6 sm:px-10 lg:px-16 py-16   bg-gray-50">
            ...
            <br />
            <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 px-10 py-30">
                {courses.map((course) => (
                    <div
                        key={course.id}
                    ...
                    >
                        ...
                        <div className="p-5 flex flex-col flex-grow">
                            ...
                            <button className="mt-auto w-full bg-black text-white text-sm font-medium py-2 px-4 rounded-lg hover:bg-gray-800 transition">
                                View details →
                            </button>
                        </div>
                    </div>
